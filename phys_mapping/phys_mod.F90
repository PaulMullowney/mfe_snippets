...
#ifdef OMP_DEVICE
!$omp declare target(phys_kernel_LITE_LOOP, phys_kernel_LITE_LOOP_REVERSED, phys_kernel_LITE_LOOP_REVERSED_HOIST)
#endif
...
!$acc end loop
#endif
end subroutine phys_kernel_LITE_LOOP_REVERSED
...
end subroutine phys_kernel_LITE_LOOP_REVERSED_HOIST
